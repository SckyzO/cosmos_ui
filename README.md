...
Dark mode first-class, 5 accent colors, 8 color palettes, 48+ components — React components and pure HTML templates.

[![Live Demo](https://img.shields.io/badge/Live_Demo-GitHub_Pages-0f0f0f?logo=github&logoColor=white)](https://sckyzo.github.io/cosmos_ui/)
[![Deploy Pages](https://github.com/SckyzO/cosmos_ui/actions/workflows/deploy-pages.yml/badge.svg)](https://github.com/SckyzO/cosmos_ui/actions/workflows/deploy-pages.yml)
