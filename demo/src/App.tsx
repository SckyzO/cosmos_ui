      ...
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-[--color-text-secondary]">Design System — Theme Preview</p>
          </div>
          <button
            onClick={() => setMode(mode === 'dark' ? 'light' : 'dark')}
            className="rounded-lg border border-[--color-border] bg-[--color-bg-panel] px-4 py-2 text-sm font-medium text-[--color-text-primary] transition-colors hover:bg-[--color-bg-elevated]"
          >
        ...
        <section className="rounded-xl border border-[--color-border] bg-[--color-bg-panel] p-6">
          <h2 className="mb-4 text-lg font-semibold text-[--color-text-primary]">Accent color</h2>
        ...
        {/* Light palettes */}
        <section className="rounded-xl border border-[--color-border] bg-[--color-bg-panel] p-6">
          <h2 className="mb-4 text-lg font-semibold text-[--color-text-primary]">Light palettes</h2>
            ...
            {LIGHT_THEMES.map((t) => (
              <button
                ...
                style={{
                  ...
                  borderColor:
                    lightTheme === t.id && mode === 'light' ? '#465fff' : t.preview.border,
        ...
        {/* Dark palettes */}
        <section className="rounded-xl border border-[--color-border] bg-[--color-bg-panel] p-6">
          <h2 className="mb-4 text-lg font-semibold text-[--color-text-primary]">Dark palettes</h2>
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            {DARK_THEMES.map((t) => (
              <button
                key={t.id}
        ...
        <section className="rounded-xl border border-[--color-border] bg-[--color-bg-panel] p-6">
          <h2 className="mb-4 text-lg font-semibold text-[--color-text-primary]">Design tokens</h2>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            {[
              ...
              >
                ...
                />
                <div>
                  <div className="font-mono text-sm text-[--color-text-primary]">{token.var}</div>
        ...
        {/* Brand palette */}
        <section className="rounded-xl border border-[--color-border] bg-[--color-bg-panel] p-6">
          <h2 className="mb-4 text-lg font-semibold text-[--color-text-primary]">Brand palette</h2>
