...
// ── Cosmos wordmark (text-only logo) ─────────────────────────────────────────
          ...
          <div className="mx-auto w-full max-w-md">
            ...
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <div>
                ...
                <input type="email" placeholder="info@example.com" className={inputCls} />
              </div>
              ...
              <div className="flex items-center justify-between">
                <label className="flex cursor-pointer items-center gap-3 text-sm font-normal text-gray-700 select-none dark:text-gray-400">
                  <div className="relative">
                    <input
                      type="checkbox"
                      className="sr-only"
                ...
                <a
                  href="#"
                  className="text-brand-500 hover:text-brand-600 dark:text-brand-400 text-sm transition-colors"
                >
                  Forgot password?
                </a>
              </div>
