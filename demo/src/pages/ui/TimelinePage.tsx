...
const events = [
  {
    ...
    desc: 'Rackscope infrastructure monitoring project initialized.',
    time: '2 hours ago',
    user: 'Alex J.',
    initials: 'AJ',
    uColor: 'bg-brand-500',
  },
  {
    ...
    desc: 'Sarah Williams joined the team as infrastructure engineer.',
    time: '4 hours ago',
    user: 'Sarah W.',
    initials: 'SW',
    uColor: 'bg-success-500',
  },
  {
    color: '#f59e0b',
    title: 'Configuration updated',
    desc: 'New storage array E-Series added to topology config.',
    time: '1 day ago',
    user: 'Michael C.',
    initials: 'MC',
    uColor: 'bg-warning-500',
  },
  {
    color: '#ef4444',
    title: 'Alert triggered',
    desc: 'CRIT alert on node r01-01-c01 — node_up check failed.',
    time: '2 days ago',
    user: 'System',
    initials: 'SY',
    uColor: 'bg-error-500',
  },
  {
    ...
    desc: 'Phase 7 frontend rebuild milestone completed.',
    time: '3 days ago',
    user: 'Emily D.',
    initials: 'ED',
    uColor: 'bg-gray-500',
